...
typedef struct MEM_Stroage_tag *MEM_Stroage;
...
char *MEM_strdup_func(MEM_Controller controller, char *filename,
                      int line, char *str);
MEM_Stroage MEM_open_storage_func(MEM_Controller controller, char *filename,
                                  int line, MEM_Stroage storage, size_t size);
...
void MEM_dispose_storage_func(MEM_Controller controller, MEM_Stroage storage);
...
void MEM_check_block_func(MEM_Controller controller, char *filename,
                          int line, void *p);
